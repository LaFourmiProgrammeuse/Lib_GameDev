...
unix:!macx: LIBS += -L$$PWD/SFML-2.5.1/linux/lib -lsfml-window
unix:!macx: LIBS += -L$$PWD/SFML-2.5.1/linux/lib -lsfml-graphics
unix:!macx: LIBS += -L$$PWD/SFML-2.5.1/linux/lib -lsfml-network
unix:!macx: LIBS += -L$$PWD/SFML-2.5.1/linux/lib -lsfml-system
unix:!macx: LIBS += -L$$PWD/SFML-2.5.1/linux/lib -lsfml-audio
